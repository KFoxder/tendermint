...
// MempoolTxResult contains results of transaction in mempool.
type MempoolTxResult struct {
	Tx []byte `protobuf:"bytes,1,opt,name=tx,proto3" json:"tx,omitempty"`
}

func (m *MempoolTxResult) Reset()         { *m = MempoolTxResult{} }
func (m *MempoolTxResult) String() string { return proto.CompactTextString(m) }
func (*MempoolTxResult) ProtoMessage()    {}
func (*MempoolTxResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{39}
}
func (m *MempoolTxResult) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MempoolTxResult) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MempoolTxResult.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MempoolTxResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MempoolTxResult.Merge(m, src)
}
func (m *MempoolTxResult) XXX_Size() int {
	return m.Size()
}
func (m *MempoolTxResult) XXX_DiscardUnknown() {
	xxx_messageInfo_MempoolTxResult.DiscardUnknown(m)
}

var xxx_messageInfo_MempoolTxResult proto.InternalMessageInfo

func (m *MempoolTxResult) GetTx() []byte {
	if m != nil {
		return m.Tx
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*MempoolTxResult)(nil), "tendermint.abci.MempoolTxResult")
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	0x11, 0xc6, 0xfb, 0xd1, 0x24, 0x1e, 0x1c, 0xd1, 0x34, 0xbc, 0x96, 0x49, 0x79, 0x5d, 0x72, 0x2c,
	0xd9, 0x26, 0x63, 0xaa, 0xa4, 0x48, 0xb1, 0x12, 0x9b, 0x80, 0x20, 0x83, 0x26, 0x45, 0x30, 0x4b,
	...
	0x70, 0xa7, 0x67, 0x55, 0xe2, 0x97, 0xe2, 0x6f, 0x2c, 0x6d, 0x5f, 0xdc, 0x1c, 0x5b, 0xdc, 0xa6,
	0xd0, 0xab, 0x77, 0x7a, 0x56, 0x23, 0xa6, 0x30, 0x5d, 0x74, 0x1d, 0xd2, 0xc7, 0xfd, 0x91, 0xd3,
	0xab, 0x24, 0x98, 0xd1, 0x2b, 0x51, 0x46, 0x77, 0xa9, 0x52, 0x23, 0xa6, 0x70, 0x6d, 0xfa, 0x2a,
	...
	0x58, 0x8e, 0x32, 0xae, 0x52, 0xd5, 0x2a, 0xd5, 0x6c, 0xc4, 0x14, 0x68, 0x7b, 0x33, 0x74, 0x1b,
	...
	0xd4, 0x3e, 0x3f, 0x7b, 0xfd, 0x77, 0xb8, 0x26, 0xf3, 0x90, 0xd7, 0xdd, 0x09, 0x7a, 0x0f, 0xf2,
	0xd8, 0xd4, 0xc5, 0x32, 0x80, 0xb9, 0xb8, 0x14, 0x79, 0x56, 0x4c, 0xdd, 0x5d, 0x44, 0x0e, 0x8b,
	0x31, 0xba, 0x09, 0x99, 0x8e, 0x35, 0x18, 0x18, 0xa4, 0xb2, 0xc4, 0xac, 0xd7, 0x23, 0x17, 0xc0,
	0xb4, 0x1a, 0x31, 0x45, 0xe8, 0xa3, 0x03, 0x28, 0xf6, 0x0d, 0x87, 0xa8, 0x8e, 0xa9, 0xd9, 0x4e,
	0xcf, 0x22, 0x4e, 0x65, 0x99, 0x79, 0xb8, 0x1c, 0xe5, 0x61, 0xdf, 0x70, 0xc8, 0x91, 0xab, 0xdc,
	...
	0xdd, 0x73, 0xa7, 0x76, 0x7a, 0x23, 0xf3, 0x51, 0xa5, 0xc8, 0x9c, 0x5e, 0x89, 0xfc, 0x91, 0x96,
	0xa6, 0xbb, 0x2e, 0x6a, 0xd4, 0xa0, 0x11, 0x53, 0x56, 0xfa, 0xe3, 0x42, 0xf4, 0x10, 0x56, 0x35,
	0xdb, 0xee, 0x9f, 0x8d, 0x7b, 0x2f, 0x31, 0xef, 0x57, 0xa3, 0xbc, 0xef, 0x50, 0x9b, 0x71, 0xf7,
	...
	,
}
...
func (m *MempoolTxResult) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MempoolTxResult) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MempoolTxResult) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MempoolTxResult) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MempoolTxResult) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MempoolTxResult: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MempoolTxResult: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
